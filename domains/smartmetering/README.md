...
* [**SetKeyOnGMeter**](smartmeteringws/configuration/setkeyongmeter.md) is an operation to transfer and set a G-meter key on a device.
* [**GetSetKeyOnGMeterResponse**](smartmeteringws/configuration/getsetkeyongmeterresponse.md) is an operation which returns the response from the [SetKeyOnGMeterRequest](smartmeteringws/configuration/setkeyongmeter.md) operation.
